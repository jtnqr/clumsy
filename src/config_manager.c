...
static const char *default_yaml_template =
    ...
    "=========================================================================="
    "==\n"
    "# This file dictates the core operational profiles and presets for packet "
    "manipulation.\n"
    "# Each profile fully controls the filtering rules, target processes, "
    "execution timers,\n"
    "# and individual functional interception modules simultaneously.\n"
    "#\n"
    "# WinDivert Filter Reference:\n"
    "# See "
    "https://github.com/basil00/Divert/wiki/"
    "WinDivert-Documentation#7-filter-language\n"
    "# "
    "--------------------------------------------------------------------------"
    "--\n"
    "\n"
